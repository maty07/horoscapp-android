...
import com.matydev.horoscapp.databinding.ActivityHoroscopeDetailBinding
...
class HoroscopeDetailActivity : AppCompatActivity() {
    ...
    private fun successState(horoscope: HoroscopeDetailState.Success) {
        ...
        val resource = when(horoscope.sign) {
            ...
            else -> R.drawable.tauro
        }
        binding.ivDetail.setImageResource(resource)
    }
