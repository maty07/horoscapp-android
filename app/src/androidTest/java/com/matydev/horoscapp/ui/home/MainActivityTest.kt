...
import com.matydev.horoscapp.ui.detail.HoroscopeDetailActivity
...
class MainActivityTest {
    ...
    fun when_horoscope_is_selected_then_open_detail() {
        onView(withId(R.id.rvHoroscope)).perform(RecyclerViewActions.actionOnItemAtPosition<RecyclerView.ViewHolder>(0, click()))
